...
const CalenderPage = () => {
 ...
 const [arrayofshiftsformanager, setArrayofshiftsformanager] = useState(allshifts); 
 const [savearrayofshiftsformanager, setsaveArrayofshiftsformanager] =  useState(allshifts); 
